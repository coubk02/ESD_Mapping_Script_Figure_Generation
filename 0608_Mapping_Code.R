...
DATA_FILE <- "/Users/katiecoubrough/Library/CloudStorage/OneDrive-UniversityofStrathclyde/PhD/Year 2/ESD/SOS_mapping.xlsx"
...
ggsave("Mapping/semester_timeline_plot_fig1.png", timeline_plot_2a, width = 10, height = 6, dpi = 600)
...
ggsave("Mapping/programme_entry_timeline_plot_fig2b.png", timeline_plot_2b, width = 10, height = 6, dpi = 600)
...
ggsave("Mapping/sdg_entry_tiles_fig5a.png", timeline_plot_2c, width = 10, height = 6, dpi = 600)
...
ggsave("Mapping/cumulative_engagement_3a.png", cumulative_engagement_plot, width = 10, height = 6, dpi = 600)
...
print(sdg_heatmap)
ggsave("Mapping/mean_sdg_heatmap_fig5b.png", sdg_heatmap, width = 10, height = 6, dpi = 600)
...
ggsave("Mapping/sdg_heatmap_by_programme_fig5d.png", sdg_heatmap_by_programme, width = 11, height = 6, dpi = 600)
...
ggsave("Mapping/methods_heatmap_fig4b.png", methods_heatmap, width = 10, height = 6, dpi = 600)
...
ggsave("Mapping/wedding_cake_heatmap.png", wedding_cake_heatmap, width = 10, height = 7, dpi = 600)
...
ggsave("Mapping/sdg_heatmap_by_year.png", sdg_heatmap_by_year, width = 10, height = 7, dpi = 600)
...
ggsave("Mapping/year_score_boxplot.png", year_score_boxplot, width = 10, height = 7, dpi = 600)
...
ggsave("Mapping/programme_score_boxplot.png", programme_score_boxplot, width = 10, height = 7, dpi = 600)
